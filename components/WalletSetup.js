...
const WalletSetup = () => {
  return (
    <div className='flex flex-col gap-y-[15px] bg-red-400 relative'>
      <div className='mb-3'>
        {/* <button className='text-[12px] text-white flex gap-2 px-[84px] py-2 rounded-lg items-center bg-primary font-medium'>Redeem points <Image src={Right} className='w-[30px]' alt='' /></button> */} hello
      </div>
