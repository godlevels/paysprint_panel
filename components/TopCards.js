  ...
  return (
    <div className='mt-4 mb-8 mx-10'>
      <div className='flex justify-between'>
        ...
        <button className='bg-green flex items-center text-white text-[14px] px-4 py-1 rounded-md'>Withdraw funds <AiOutlineArrowRight /> </button>
      </div>
      <div className="grid lg:grid-cols-6 gap-4 p-4">
        <div className="lg:col-span-2 col-span-1 bg-white w-full border p-4 rounded-lg">
          ...
          <div className="flex justify-between">
            ...
            <h2 className='flex gap-2 items-center text-green'>2.34% <span><Image src={Arrow} /></span></h2>
          </div>
        </div>
        <div className="lg:col-span-2 col-span-1 bg-white w-full border p-4 rounded-lg">
